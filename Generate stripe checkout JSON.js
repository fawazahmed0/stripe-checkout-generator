...
var stripe = require('stripe')('sk_live_51dfaaerae');
// ID of product, take from dashboard
var productid = 'prod_HXr86VxRVpnaTN'

// Not keeping UGX here
// Refer
var zeroDecimal = ["bif","clp","djf","gnf","huf","jpy","kmf","krw","mga","pyg","rwf","vnd","vuv","xaf","xof","xpf"]
...
for (currency of allCurrency){

var singleTime = await stripe.prices.create({product: productid, unit_amount: 1, currency: currency})
var multiTime = await stripe.prices.create({product: productid, unit_amount: 1, currency: currency, recurring: {interval: 'month'}})
